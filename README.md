...
IMPORTANT:
If the challenge is pretty simple you may add additional improvements: validation serverside, better UX(delete dialogs), taking the hard path(secure web api), improving backend(adding a db server and choosing a hosting)
